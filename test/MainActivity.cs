...
namespace AndroidApp
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            // https://learn.microsoft.com/en-us/dotnet/maui/migration/native-essentials?view=net-maui-9.0&tabs=android
            // Now Xamarin Essentials are MAUI essentials (part of Microsoft.Maui.ApplicationModel)
            // They are initialized by project settings like:
